  ...
  return (
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {skillsListing.map((item, index) => (
            ...
            >
              <div className="w-14 h-14 rounded-full bg-orange-500/20 flex items-center justify-center mb-6 group-hover:scale-110 transition">
      ...
      <motion.section
        ...
        className="py-20 container mx-auto px-6"
      >
        <div className="bg-foreground/5 backdrop-blur-xl border border-foreground/10 rounded-3xl p-8 md:p-16 flex flex-col lg:flex-row items-center gap-12 relative overflow-hidden">
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-orange-500/20 rounded-full blur-[80px]"></div>
          ...
          <div className="w-full lg:w-2/3 space-y-6 relative z-10">
            ...
            <p className="text-foreground/60 leading-relaxed text-sm md:text-base">
              ...
              surface, I engineer scalable, enterprise-ready architectures using
              Java Spring Boot, grounded by the rock-solid reliability of
              PostgreSQL. I don’t just build apps; I craft seamless digital
              ecosystems where complex engineering meets effortless aesthetic.
            </p>
            <div className="flex flex-col xl:flex-row items-start xl:items-center gap-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <a
                  href="https://www.facebook.com/menglongkeo07"
                  target="_blank"
                  aria-label="Facebook"
                  className="p-2.5 rounded-full bg-foreground/5 hover:bg-orange-500/20 hover:text-orange-500 hover:border-orange-500/50 transition border border-foreground/10 text-foreground/70"
                >
                  <SiFacebook size={18} />
                </a>
                <a
                  href="https://www.instagram.com/menglongkeo"
                  target="_blank"
                ...
                <a
                  href="https://www.youtube.com/@GoWithLong"
                  target="_blank"
                  aria-label="Youtube"
                  className="p-2.5 rounded-full bg-foreground/5 hover:bg-orange-500/20 hover:text-orange-500 hover:border-orange-500/50 transition border border-foreground/10 text-foreground/70"
                >
                ...
                <a
                  href="https://www.tiktok.com/@m3ngl0ng"
                  target="_blank"
                  aria-label="TikTok"
                  className="p-2.5 rounded-full bg-foreground/5 hover:bg-orange-500/20 hover:text-orange-500 hover:border-orange-500/50 transition border border-foreground/10 text-foreground/70"
                >
                ...
                <a
                  href="https://github.com/MenglongK"
                  target="_blank"
                  aria-label="GitHub"
                  className="p-2.5 rounded-full bg-foreground/5 hover:bg-orange-500/20 hover:text-orange-500 hover:border-orange-500/50 transition border border-foreground/10 text-foreground/70"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-foreground/10 mt-8">
              <div className="text-center">
                <div className="w-16 h-16 mx-auto rounded-full bg-foreground/5 border border-orange-500/50 flex items-center justify-center text-xl font-bold text-orange-500 mb-2 shadow-[0_0_10px_rgba(249,115,22,0.2)]">
                  98%
                </div>
