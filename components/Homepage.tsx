                        ...
                        <div
                            ...
                            <div className="w-full md:w-2/3 space-y-6 relative z-10">
                                ...
                                <div
                                    ...
                                    <div className="text-center">
                                        <div
                                            className="w-16 h-16 mx-auto rounded-full bg-white/5 border border-orange-500/50 flex items-center justify-center text-xl font-bold text-orange-500 mb-2 shadow-[0_0_10px_rgba(249,115,22,0.2)]">3
                                        </div>
